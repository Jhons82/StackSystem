<div class="modal fade modal-container login-form" id="loginModal" tabindex="-1" role="dialog" aria-labelledby="loginModalTitle">
            ...
            <div class="modal-body">
                <form method="post" id="login">
                    <div class="form-group">
                        ...
                        <input class="form-control form--control" type="email" name="email" id="email" placeholder="Dirección de correo" autocomplete="username">
                    </div>
                    <div class="form-group">
                        <label class="fs-14 text-black fw-medium lh-18" for="password">Contraseña</label>
                        <div class="input-group mb-1">
                            <input class="form-control form--control password-field" type="password" name="password" id="password" placeholder="Introduce la contraseña" autocomplete="current-password">
                    ...
                    <div class="text-center">
                        <button class="btn theme-btn google-btn d-flex align-items-center justify-content-center w-100 mb-2" type="button">
                            ...
                            <span class="flex-grow-1">Iniciar sesión con Google</span>
                        </button>
                        ...
                        <button class="btn theme-btn twitter-btn d-flex align-items-center justify-content-center w-100" type="button">
                            ...
                            <span class="flex-grow-1"> Twitter</span>
                        </button> -->
                    </div>
                </form>
            </div>
