<section class="footer-area pt-80px bg-dark position-relative">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 responsive-column-half">
                <div class="footer-item">
                    <h3 class="fs-18 fw-bold pb-2 text-white">Información legal</h3>
                    <ul class="generic-list-item generic-list-item-hover-underline pt-3 generic-list-item-white">
            ...
            <div class="col-lg-3 responsive-column-half">
                <div class="footer-item">
                    <h3 class="fs-18 fw-bold pb-2 text-white">Síguenos</h3>
                    <ul class="generic-list-item generic-list-item-hover-underline pt-3 generic-list-item-white">
                        <li><a href="#"><i class="la la-facebook me-1"></i> Facebook</a></li>
                        <li><a href="#"><i class="la la-twitter me-1"></i> Twitter</a></li>
    ...
    <div class="container">
        <div class="row align-items-center pb-4 copyright-wrap">
            ...
            <div class="col-lg-6">
                <p class="copyright-desc text-end fs-14">Copyright &copy; <span id="copyright-date"></span> <a href="#">J-GOD</a></p>
            </div><!-- end col-lg-6 -->
        </div><!-- end row -->
    </div><!-- end container -->
