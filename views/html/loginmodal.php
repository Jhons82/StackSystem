            ...
            <div class="modal-body">
                <form method="post" id="login">
                    <div class="form-group">
                        ...
                        <input class="form-control form--control" type="email" name="email" id="email" placeholder="Dirección de correo" autocomplete="username" required>
                    </div>
                    <div class="form-group">
                        <label class="fs-14 text-black fw-medium lh-18" for="password">Contraseña</label>
                        <div class="input-group mb-1">
                            <input class="form-control form--control password-field" type="password" name="password" id="password" placeholder="Introduce la contraseña" autocomplete="current-password" required>
