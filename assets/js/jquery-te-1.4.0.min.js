...
(function (e) {
  e.fn.jqte = function (t) {
    ...
    return this.each(function () {
      ...
      // Agrega todos los eventos válidos, excluyendo los obsoletos
      v.bind("keypress keyup keydown drop cut copy paste", function () {
      ...
      // Agrega observer para reemplazar DOMCharacterDataModified y DOMSubtreeModified
      const targetNode = v[0]; // v debe ser un objeto jQuery
      if (targetNode) {
        const config = {
          childList: true,
          subtree: true,
        ...
        const observerCallback = function (mutationsList, observer) {
          if (!p.data("sourceOpened")) e(targetNode).trigger("change");
          X();
          if (e.isFunction(u.change)) u.change();
          if (u.placeholder && u.placeholder != "")
            e(targetNode).text() != "" ? M.hide() : M.show();
        };
